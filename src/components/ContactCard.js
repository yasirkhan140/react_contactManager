...
function ContactCard (props){
    ...
    return(
        ...
        <div className="conatact" style={style.contactCard}>
            ...
            <div className="content-div" style={style.contentDiv}>
            ...
            <div className="btn-div" style={style.btnDiv}>
                <button className="edit-btn heigth btn" style={style.editBtn} id ={id} onClick={EditClick} value={index}>
                    <i className="fa-solid fa-pen"></i>
                </button>
                               
                <button className="view-btn heigth btn" style={style.viewBtn} onClick={handleView} id ={id} value={index}>
                    <i className="fa-solid fa-eye"></i>
                </button>
                
                <button className="delete-btn heigth btn" style={style.deleteBtn} onClick= {handleDelete} id={id} value={index}>
                    <ToastContainer />
